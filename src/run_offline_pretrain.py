...
from src.drl.offline import iql_pretrain


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run offline IQL pretraining")
...
def main(argv: list[str] | None = None) -> None:
    ...
    iql_pretrain.run(args.config, prefer_device=args.device, overrides=overrides)
